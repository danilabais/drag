<template>
  <div class="inventory__wrapper common-wrapper">
    <div @dragover.prevent @dragenter.prevent v-for="(cell,idx) in array" @drop="onDrop($event,cell.id)" :key="idx" class="inventory__cell">
        <CellComponent @onDragStart="onDragStart" :item="cell.item"/>
    </div>
  </div>
  {{array}}
</template>
...
const array = ref([{id:0, item: null},{id:1,item: {type: 'green', value: 3, id: 23} },{id:2,item: null},{id:3, item: null},{id:4, item: null},{id:5, item: null}])
